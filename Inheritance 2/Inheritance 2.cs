...
namespace ProjectInheritance2
{
    public class DasarPlusKomisiKaryawan
    {
        ...
        public DasarPlusKomisiKaryawan(string namaDepan, string namaBelakang, string nomorKTP, decimal penjualanKotor, decimal tingkatKomisi, decimal gajiPokok)
        {
            NamaDepan = namaDepan;
    ...
    class TesDasarPlusKomisiKaryawan
    {
        static void Main()
        {
            var karyawan = new DasarPlusKomisiKaryawan("Bob", "Lewis", "333-33-3333", 5000.00M, .04M, 300.00M);
